...
zhandou_gongji suijidan_daodan_level1 = { "随机弹","刀弹lv1",2,0,0,5,0,10,2,10,"A0" };//A0
zhandou_gongji suijidan_xiaoyu_level1 = { "随机弹","小玉lv1",2,6,0,4,0,10,3,8,"A1" };//A1
...
zhandou_yidong weiyi_level1 = { "移动","微移",0,3,2,NULL,"B0"};//B0
zhandou_yidong zhongfuyidong_level1 = { "移动","中幅移动",0,5,4,NULL,"B1"};//B1		记得到时候把这个指针删掉（我只是为了调试一下移动时发射弹幕的功能）
zhandou_yidong gaosuchuanxing_level1 = { "移动","高速穿行",0,7,6,NULL,"B2"};//B2
zhandou_yidong ceshi_yidongsheji = { "移动","测试——移动射击",5,5,3,&suijidan_daodan_level1,"B1000" };//B1000
